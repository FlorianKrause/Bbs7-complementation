...
genopheno <- read.table("fam2input.txt", sep = " ", header = TRUE, na.strings=c(""), colClasses = c("character"))
...
lkup <- NA
lkup[df[, "ORDERED.GENOTYPES"]=="MDC/B6N"] <- "I8∆2/B6N"
lkup[df[, "ORDERED.GENOTYPES"]=="MDC/MDC"] <- "I8∆2/I8∆2"
lkup[df[, "ORDERED.GENOTYPES"]=="BFMI/MDC"] <- "BFMI/I8∆2"
...
nwo <- ordered(df$ORDERED.GENOTYPES, levels = c("BFMI/BFMI", "BFMI/I8∆2", "I8∆2/I8∆2", "I8∆2/B6N", "BFMI/B6N", "B6N/B6N"))
